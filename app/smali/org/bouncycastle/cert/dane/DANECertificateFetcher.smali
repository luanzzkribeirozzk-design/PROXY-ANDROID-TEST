...
.method public fetch(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {v0, v2}, Lorg/bouncycastle/cert/dane/DANEEntryFetcherFactory;->build(Ljava/lang/String;)Lorg/bouncycastle/cert/dane/DANEEntryFetcher;
    ...
    invoke-virtual {v1, v0}, Lorg/bouncycastle/cert/dane/DANEEntrySelector;->match(Ljava/lang/Object;)Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {v0}, Lorg/bouncycastle/cert/dane/DANEEntry;->getCertificate()Lorg/bouncycastle/cert/X509CertificateHolder;
