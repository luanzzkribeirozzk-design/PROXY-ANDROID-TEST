...
.method static constructor <clinit>()V
    ...
    const-class v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;
    ...
    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->LOG:Ljava/util/logging/Logger;

    new-instance v2, Lorg/bouncycastle/crypto/CryptoServicesPermission;

    const-string v3, "globalConfig"

    invoke-direct {v2, v3}, Lorg/bouncycastle/crypto/CryptoServicesPermission;-><init>(Ljava/lang/String;)V

    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->CanSetDefaultProperty:Ljava/security/Permission;

    new-instance v2, Lorg/bouncycastle/crypto/CryptoServicesPermission;

    const-string v3, "threadLocalConfig"

    invoke-direct {v2, v3}, Lorg/bouncycastle/crypto/CryptoServicesPermission;-><init>(Ljava/lang/String;)V

    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->CanSetThreadProperty:Ljava/security/Permission;

    new-instance v2, Lorg/bouncycastle/crypto/CryptoServicesPermission;

    const-string v3, "defaultRandomConfig"

    invoke-direct {v2, v3}, Lorg/bouncycastle/crypto/CryptoServicesPermission;-><init>(Ljava/lang/String;)V

    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->CanSetDefaultRandom:Ljava/security/Permission;
    ...
    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->CanSetConstraints:Ljava/security/Permission;

    new-instance v2, Ljava/lang/ThreadLocal;

    invoke-direct {v2}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->threadProperties:Ljava/lang/ThreadLocal;
    ...
    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->globalProperties:Ljava/util/Map;

    new-instance v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar$ThreadLocalSecureRandomProvider;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lorg/bouncycastle/crypto/CryptoServicesRegistrar$ThreadLocalSecureRandomProvider;-><init>(Lorg/bouncycastle/crypto/CryptoServicesRegistrar$1;)V

    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->defaultRandomProviderImpl:Lorg/bouncycastle/crypto/SecureRandomProvider;
    ...
    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->noConstraintsImpl:Lorg/bouncycastle/crypto/CryptoServicesConstraints;

    new-instance v2, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {v2}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->defaultSecureRandomProvider:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v2, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {v2}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    sput-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->servicesConstraints:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v4, v5, v11}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Lorg/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/DSAValidationParameters;)V
    ...
    invoke-direct {v7, v8, v11}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v4, v5, v6, v7, v8}, Lorg/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/DSAValidationParameters;)V
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lorg/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/DSAValidationParameters;)V

    sget-object v6, Lorg/bouncycastle/crypto/CryptoServicesRegistrar$Property;->DSA_DEFAULT_PARAMS:Lorg/bouncycastle/crypto/CryptoServicesRegistrar$Property;

    const/4 v7, 0x4

    new-array v7, v7, [Lorg/bouncycastle/crypto/params/DSAParameters;
    ...
    invoke-static {v6, v7}, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->localSetGlobalProperty(Lorg/bouncycastle/crypto/CryptoServicesRegistrar$Property;[Ljava/lang/Object;)V

    sget-object v6, Lorg/bouncycastle/crypto/CryptoServicesRegistrar$Property;->DH_DEFAULT_PARAMS:Lorg/bouncycastle/crypto/CryptoServicesRegistrar$Property;
    ...
    sget-object v2, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->servicesConstraints:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v3, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->noConstraintsImpl:Lorg/bouncycastle/crypto/CryptoServicesConstraints;
...
.method public static setServicesConstraints(Lorg/bouncycastle/crypto/CryptoServicesConstraints;)V
    ...
    :cond_1
    sget-object v0, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->LOG:Ljava/util/logging/Logger;

    const-string v1, "attempt to override pre-configured constraints ignored"
...
.method private static toDH(Lorg/bouncycastle/crypto/params/DSAParameters;)Lorg/bouncycastle/crypto/params/DHParameters;
    ...
    new-instance v7, Lorg/bouncycastle/crypto/params/DHValidationParameters;
    ...
    invoke-virtual {v8}, Lorg/bouncycastle/crypto/params/DSAValidationParameters;->getSeed()[B
    ...
    invoke-virtual {v9}, Lorg/bouncycastle/crypto/params/DSAValidationParameters;->getCounter()I

    move-result v9

    invoke-direct {v7, v8, v9}, Lorg/bouncycastle/crypto/params/DHValidationParameters;-><init>([BI)V
