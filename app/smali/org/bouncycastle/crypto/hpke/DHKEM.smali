...
.method protected constructor <init>(S)V
    ...
    invoke-direct {v0, v6}, Lorg/bouncycastle/crypto/hpke/HKDF;-><init>(S)V

    iput-object v0, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->hkdf:Lorg/bouncycastle/crypto/hpke/HKDF;

    new-instance v1, Lorg/bouncycastle/math/ec/custom/sec/SecP256R1Curve;

    invoke-direct {v1}, Lorg/bouncycastle/math/ec/custom/sec/SecP256R1Curve;-><init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->domainParams:Lorg/bouncycastle/crypto/params/ECDomainParameters;
    ...
    iput-byte v8, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->bitmask:B

    iput v7, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->Nsk:I

    iput v7, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->Nsecret:I
    ...
    new-instance v1, Lorg/bouncycastle/math/ec/custom/sec/SecP384R1Curve;

    invoke-direct {v1}, Lorg/bouncycastle/math/ec/custom/sec/SecP384R1Curve;-><init>()V
    ...
    const-string v5, "a335926aa319a27a1d00896a6773a4827acdac73"
    ...
    const-string v5, "d09e8800291cb85396cc6717393284aaa0da64ba"
    ...
    iput-byte v6, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->bitmask:B
...
.method private ExtractAndExpand([B[B)[B
    ...
    invoke-virtual {v0, v1, v2, v3, p1}, Lorg/bouncycastle/crypto/hpke/HKDF;->LabeledExtract([B[BLjava/lang/String;[B)[B
    ...
    iget v5, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->Nsecret:I
...
.method protected AuthDecap([BLorg/bouncycastle/crypto/AsymmetricCipherKeyPair;Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
    ...
    invoke-static {p1, v1, v2}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B[B)[B

    move-result-object v1

    invoke-direct {p0, v0, v1}, Lorg/bouncycastle/crypto/hpke/DHKEM;->ExtractAndExpand([B[B)[B
...
.method protected AuthEncap(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;)[[B
    ...
    invoke-virtual {p0, v4}, Lorg/bouncycastle/crypto/hpke/DHKEM;->SerializePublicKey(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B

    move-result-object v4

    invoke-static {v1, v3, v4}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B[B)[B

    move-result-object v3

    invoke-direct {p0, v2, v3}, Lorg/bouncycastle/crypto/hpke/DHKEM;->ExtractAndExpand([B[B)[B
...
.method public DeriveKeyPair([B)Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    invoke-virtual {v0, v4, v2, v1, p1}, Lorg/bouncycastle/crypto/hpke/HKDF;->LabeledExtract([B[BLjava/lang/String;[B)[B
    ...
    const-string v1, "DeriveKeyPairError"
    ...
    iget v5, p0, Lorg/bouncycastle/crypto/hpke/DHKEM;->Nsk:I
    ...
    invoke-direct {v3, v8, v0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-virtual {v0, v1, v3}, Lorg/bouncycastle/math/ec/FixedPointCombMultiplier;->multiply(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v1, v3, v2}, Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/ECDomainParameters;)V
...
.method public DeserializePrivateKey([B[B)Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    invoke-direct {v0, v1, v3}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;-><init>(Lorg/bouncycastle/math/ec/ECPoint;Lorg/bouncycastle/crypto/params/ECDomainParameters;)V
    ...
    invoke-direct {v2, p1}, Lorg/bouncycastle/crypto/params/X448PrivateKeyParameters;-><init>([B)V
    ...
    invoke-direct {v2, p1}, Lorg/bouncycastle/crypto/params/X25519PrivateKeyParameters;-><init>([B)V
...
.method protected Encap(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;)[[B
    ...
    invoke-virtual {p0, v2}, Lorg/bouncycastle/crypto/hpke/DHKEM;->SerializePublicKey(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
    ...
    invoke-direct {p0, v1, v3}, Lorg/bouncycastle/crypto/hpke/DHKEM;->ExtractAndExpand([B[B)[B
