...
.method public calculateAgreement(Lorg/bouncycastle/crypto/CipherParameters;)Ljava/math/BigInteger;
    ...
    const-string v1, "MQV public key components have wrong domain parameters"
    ...
    const-string v1, "MQV key domain parameters do not have Q set"
    ...
    :cond_1
    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;->getParameters()Lorg/bouncycastle/crypto/params/DHParameters;
    ...
    sget-object v1, Lorg/bouncycastle/crypto/agreement/MQVBasicAgreement;->ONE:Ljava/math/BigInteger;
    ...
    const-string v1, "1 is not a valid agreement value for MQV"
