...
.method public calculateAgreement(Lorg/bouncycastle/crypto/CipherParameters;[BI)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/agreement/XDHUnifiedAgreement;->xAgreement:Lorg/bouncycastle/crypto/RawAgreement;

    invoke-interface {v2}, Lorg/bouncycastle/crypto/RawAgreement;->getAgreementSize()I

    move-result v2

    add-int/2addr v2, p3

    invoke-interface {v0, v1, p2, v2}, Lorg/bouncycastle/crypto/RawAgreement;->calculateAgreement(Lorg/bouncycastle/crypto/CipherParameters;[BI)V
