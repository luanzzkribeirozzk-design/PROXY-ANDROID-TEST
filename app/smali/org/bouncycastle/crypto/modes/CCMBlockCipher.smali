...
.method private getMacSize(ZI)I
    ...
    const-string v1, "tag length in octets must be one of {4,6,8,10,12,14,16}"
...
.method public processPacket([BII[BI)I
    ...
    invoke-direct {v2, v5, v0}, Lorg/bouncycastle/crypto/params/ParametersWithIV;-><init>(Lorg/bouncycastle/crypto/CipherParameters;[B)V

    invoke-interface {v4, v1, v2}, Lorg/bouncycastle/crypto/BlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v4, v0, v3, v5, v3}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-interface {v4, p1, v1, p4, v0}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-static {p1, v1, v6, v3, v7}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-interface {v4, v6, v3, v6, v3}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    add-int v4, p3, p2

    sub-int v1, v4, v1

    invoke-static {v6, v3, p4, v0, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    add-int v0, p5, p3

    iget v1, p0, Lorg/bouncycastle/crypto/modes/CCMBlockCipher;->macSize:I

    invoke-static {v5, v3, p4, v0, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-interface {v4, v0, v3, v1, v3}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-interface {v4, v5, v3, v5, v3}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
