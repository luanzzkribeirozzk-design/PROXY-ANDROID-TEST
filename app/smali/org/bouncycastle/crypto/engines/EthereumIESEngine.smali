...
.method private decryptBlock([BII)[B
    ...
    invoke-interface {v8, v1, v5, v10}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {v8, v9, v5}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
    ...
    invoke-interface {v1, v8}, Lorg/bouncycastle/crypto/Mac;->init(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v1, v8, v5, v9}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->commonMac:[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->param:Lorg/bouncycastle/crypto/params/IESParameters;
    ...
    invoke-virtual {v1, v5, v0}, Lorg/bouncycastle/crypto/BufferedBlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method private encryptBlock([BII)[B
    ...
    invoke-interface {v6, v0, v5, v8}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {v6, v7, v5}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
    ...
    invoke-interface {v0, v6}, Lorg/bouncycastle/crypto/Mac;->init(Lorg/bouncycastle/crypto/CipherParameters;)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->mac:Lorg/bouncycastle/crypto/Mac;

    iget-object v6, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->IV:[B

    iget-object v7, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->IV:[B

    array-length v7, v7

    invoke-interface {v0, v6, v5, v7}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->commonMac:[B
...
.method public processBlock([BII)[B
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->forEncryption:Z
    ...
    :cond_2
    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->keyParser:Lorg/bouncycastle/crypto/KeyParser;
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/engines/EthereumIESEngine;->pubParam:Lorg/bouncycastle/crypto/CipherParameters;
    :try_end_1
