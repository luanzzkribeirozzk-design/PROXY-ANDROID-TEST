...
.method public constructor <init>([B)V
    ...
    new-array v0, v3, [Lorg/bouncycastle/crypto/digests/Blake2sDigest;

    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->S:[Lorg/bouncycastle/crypto/digests/Blake2sDigest;
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->BLAKE2S_BLOCKBYTES:I

    iput v2, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->BLAKE2S_KEYBYTES:I

    iput v2, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->BLAKE2S_OUTBYTES:I

    iput v3, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->PARALLELISM_DEGREE:I
...
.method private init([B)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->key:[B
    ...
    iput v6, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->fanout:I

    iput v5, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->depth:I

    const-wide/16 v2, 0x20

    iput-wide v2, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->innerHashLength:J

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->param:[B

    iget v2, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->digestLength:I
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->fanout:I
    ...
    invoke-static {v1, v0, v6}, Lorg/bouncycastle/util/Pack;->intToLittleEndian(I[BI)V
    ...
    invoke-direct {v0, v2, v3}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;-><init>([B[B)V
    ...
    invoke-static {v0, v2, v6}, Lorg/bouncycastle/util/Pack;->intToLittleEndian(I[BI)V
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->param:[B

    invoke-direct {v3, v4, v5}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;-><init>([B[B)V
    ...
    invoke-virtual {v3, v2, v1, v4}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->update([BII)V
...
.method public doFinal([BI)I
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->bufferPos:I
    ...
    invoke-virtual {v5, v6, v7, v1}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->update([BII)V
    ...
    invoke-virtual {v1, v5, v3}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->doFinal([BI)I
    ...
    invoke-virtual {v2, v4, v3, v9}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->update([BII)V
...
.method public reset()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->key:[B
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->keyLength:I
    ...
    invoke-virtual {v3, v2, v1, v5}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->update([BII)V
...
.method public update(B)V
    ...
    invoke-virtual {p0, v0, v2, v1}, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->update([BII)V
...
.method public update([BII)V
    ...
    rsub-int v2, v0, 0x200

    if-eqz v0, :cond_1

    if-lt p3, v2, :cond_1

    iget-object v3, p0, Lorg/bouncycastle/crypto/digests/Blake2spDigest;->buffer:[B
    ...
    invoke-virtual {v3, v4, v5, v7}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->update([BII)V
    ...
    invoke-virtual {v4, p1, v1, v7}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->update([BII)V
