...
.method private static createBcryptString(Ljava/lang/String;[B[BI)Ljava/lang/String;
    ...
    invoke-static {v1, p2}, Lorg/bouncycastle/crypto/generators/OpenBSDBCrypt;->encodeData(Ljava/lang/StringBuilder;[B)V

    invoke-static {p1, p2, p3}, Lorg/bouncycastle/crypto/generators/BCrypt;->generate([B[BI)[B

    move-result-object v0

    invoke-static {v1, v0}, Lorg/bouncycastle/crypto/generators/OpenBSDBCrypt;->encodeData(Ljava/lang/StringBuilder;[B)V
...
.method private static doCheckPassword(Ljava/lang/String;[B)Z
    ...
    :goto_0
    sget-object v3, Lorg/bouncycastle/crypto/generators/OpenBSDBCrypt;->allowedVersions:Ljava/util/Set;
    ...
    invoke-static {v2}, Lorg/bouncycastle/crypto/generators/OpenBSDBCrypt;->decodeSaltString(Ljava/lang/String;)[B

    move-result-object v2

    invoke-static {v1, p1, v2, v0}, Lorg/bouncycastle/crypto/generators/OpenBSDBCrypt;->doGenerate(Ljava/lang/String;[B[BI)Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, v0}, Lorg/bouncycastle/util/Strings;->constantTimeAreEqual(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private static doGenerate(Ljava/lang/String;[B[BI)Ljava/lang/String;
    ...
    sget-object v1, Lorg/bouncycastle/crypto/generators/OpenBSDBCrypt;->allowedVersions:Ljava/util/Set;
