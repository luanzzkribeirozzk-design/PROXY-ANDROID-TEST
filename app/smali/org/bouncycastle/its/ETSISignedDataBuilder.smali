...
.method public build(Lorg/bouncycastle/its/operator/ITSContentSigner;)Lorg/bouncycastle/its/ETSISignedData;
    ...
    invoke-virtual {v0, v3}, Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;->setSigner(Lorg/bouncycastle/oer/its/ieee1609dot2/SignerIdentifier;)Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;

    move-result-object v0

    invoke-virtual {v0, v1}, Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;->setSignature(Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/Signature;)Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;

    move-result-object v0

    invoke-virtual {v0}, Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;->createSignedData()Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData;

    move-result-object v0

    invoke-direct {v2, v0}, Lorg/bouncycastle/its/ETSISignedData;-><init>(Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData;)V
...
.method public build(Lorg/bouncycastle/its/operator/ITSContentSigner;Ljava/util/List;)Lorg/bouncycastle/its/ETSISignedData;
    ...
    invoke-static {v0, v2}, Lorg/bouncycastle/its/ETSISignedDataBuilder;->write(Ljava/io/OutputStream;[B)V
    ...
    check-cast v0, Lorg/bouncycastle/its/ITSCertificate;
    ...
    invoke-static {v0}, Lorg/bouncycastle/oer/its/ieee1609dot2/Certificate;->getInstance(Ljava/lang/Object;)Lorg/bouncycastle/oer/its/ieee1609dot2/Certificate;
    ...
    invoke-static {v0, v3}, Lorg/bouncycastle/its/operator/ECDSAEncoder;->toITS(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;[B)Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/Signature;
    ...
    invoke-virtual {v4, v1}, Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;->setTbsData(Lorg/bouncycastle/oer/its/ieee1609dot2/ToBeSignedData;)Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;

    move-result-object v1

    new-instance v4, Lorg/bouncycastle/oer/its/ieee1609dot2/SequenceOfCertificate;

    invoke-direct {v4, v2}, Lorg/bouncycastle/oer/its/ieee1609dot2/SequenceOfCertificate;-><init>(Ljava/util/List;)V

    invoke-static {v4}, Lorg/bouncycastle/oer/its/ieee1609dot2/SignerIdentifier;->certificate(Lorg/bouncycastle/oer/its/ieee1609dot2/SequenceOfCertificate;)Lorg/bouncycastle/oer/its/ieee1609dot2/SignerIdentifier;

    move-result-object v2

    invoke-virtual {v1, v2}, Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;->setSigner(Lorg/bouncycastle/oer/its/ieee1609dot2/SignerIdentifier;)Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;

    move-result-object v1

    invoke-virtual {v1, v0}, Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;->setSignature(Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/Signature;)Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData$Builder;
    ...
    invoke-direct {v3, v0}, Lorg/bouncycastle/its/ETSISignedData;-><init>(Lorg/bouncycastle/oer/its/ieee1609dot2/SignedData;)V
