...
.method public wrap([B)Lorg/bouncycastle/oer/its/ieee1609dot2/EncryptedDataEncryptionKey;
    ...
    iget-object v4, p0, Lorg/bouncycastle/its/jcajce/JceETSIKeyWrapper;->recipientHash:[B

    const/4 v5, 0x1

    invoke-direct {v3, v4, v5}, Lorg/bouncycastle/jcajce/spec/IESKEMParameterSpec;-><init>([BZ)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/its/jcajce/JceETSIKeyWrapper;->recipientKey:Ljava/security/interfaces/ECPublicKey;
    ...
    invoke-static {v4}, Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EccP256CurvePoint;->createEncodedPoint([B)Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EccP256CurvePoint;

    move-result-object v4

    invoke-virtual {v3, v4}, Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey$Builder;->setV(Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EccP256CurvePoint;)Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey$Builder;
    ...
    invoke-virtual {v3, v4}, Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey$Builder;->setC([B)Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey$Builder;
    ...
    invoke-virtual {v3, v0}, Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey$Builder;->setT([B)Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey$Builder;

    move-result-object v0

    invoke-virtual {v0}, Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey$Builder;->createEciesP256EncryptedKey()Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey;
    ...
    invoke-static {v0}, Lorg/bouncycastle/oer/its/ieee1609dot2/EncryptedDataEncryptionKey;->eciesNistP256(Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey;)Lorg/bouncycastle/oer/its/ieee1609dot2/EncryptedDataEncryptionKey;
    ...
    invoke-static {v0}, Lorg/bouncycastle/oer/its/ieee1609dot2/EncryptedDataEncryptionKey;->eciesBrainpoolP256r1(Lorg/bouncycastle/oer/its/ieee1609dot2/basetypes/EciesP256EncryptedKey;)Lorg/bouncycastle/oer/its/ieee1609dot2/EncryptedDataEncryptionKey;
    ...
    const-string v1, "recipient key curve is not P-256 or Brainpool P256r1"
