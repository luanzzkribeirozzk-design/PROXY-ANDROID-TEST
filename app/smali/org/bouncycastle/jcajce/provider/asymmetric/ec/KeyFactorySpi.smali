...
.method protected engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    ...
    :try_start_0
    instance-of v1, p1, Lorg/bouncycastle/jce/spec/ECPublicKeySpec;
    ...
    invoke-direct {v1, v2, p1, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;-><init>(Ljava/lang/String;Lorg/bouncycastle/jce/spec/ECPublicKeySpec;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    invoke-direct {v1, v2, p1, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/BCECPublicKey;-><init>(Ljava/lang/String;Ljava/security/spec/ECPublicKeySpec;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    :try_end_0
    ...
    :cond_1
    :try_start_1
    instance-of v1, p1, Lorg/bouncycastle/jcajce/spec/OpenSSHPublicKeySpec;
    ...
    invoke-static {v1}, Lorg/bouncycastle/crypto/util/OpenSSHPublicKeyUtil;->parsePublicKey([B)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;

    move-result-object v2

    instance-of v1, v2, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;
    ...
    new-instance v7, Lorg/bouncycastle/jce/spec/ECPublicKeySpec;
    ...
    invoke-direct {v7, v8, v1}, Lorg/bouncycastle/jce/spec/ECPublicKeySpec;-><init>(Lorg/bouncycastle/math/ec/ECPoint;Lorg/bouncycastle/jce/spec/ECParameterSpec;)V

    invoke-virtual {p0, v7}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/KeyFactorySpi;->engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
...
.method protected engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    :try_start_0
    new-instance v6, Lorg/bouncycastle/jcajce/spec/OpenSSHPublicKeySpec;
    ...
    invoke-direct {v7, v8, v0}, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;-><init>(Lorg/bouncycastle/math/ec/ECPoint;Lorg/bouncycastle/crypto/params/ECDomainParameters;)V

    invoke-static {v7}, Lorg/bouncycastle/crypto/util/OpenSSHPublicKeyUtil;->encodePublicKey(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B

    move-result-object v0

    invoke-direct {v6, v0}, Lorg/bouncycastle/jcajce/spec/OpenSSHPublicKeySpec;-><init>([B)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "unable to produce encoding: "
