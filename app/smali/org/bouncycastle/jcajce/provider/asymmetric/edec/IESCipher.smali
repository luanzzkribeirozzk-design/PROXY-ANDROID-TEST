...
.method public constructor <init>(Lorg/bouncycastle/crypto/engines/IESEngine;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->engineParam:Ljava/security/AlgorithmParameters;

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->engineSpec:Lorg/bouncycastle/jce/spec/IESParameterSpec;

    iput-boolean v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->dhaesMode:Z

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->otherKeyParameter:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    iput v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->ivLength:I
...
.method public constructor <init>(Lorg/bouncycastle/crypto/engines/IESEngine;I)V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->dhaesMode:Z
...
.method public engineDoFinal([BII)[B
    ...
    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->engineSpec:Lorg/bouncycastle/jce/spec/IESParameterSpec;

    invoke-virtual {v6}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->getMacKeySize()I

    move-result v6

    iget-object v7, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->engineSpec:Lorg/bouncycastle/jce/spec/IESParameterSpec;

    invoke-virtual {v7}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->getCipherKeySize()I

    move-result v7

    invoke-direct {v1, v0, v3, v6, v7}, Lorg/bouncycastle/crypto/params/IESWithCipherParameters;-><init>([B[BII)V
    ...
    :goto_0
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->otherKeyParameter:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;

    if-eqz v1, :cond_3

    :try_start_0
    iget v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->state:I
    ...
    invoke-virtual {v1, v2, v3, v4, v0}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(ZLorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {v0, v5, v1, v2}, Lorg/bouncycastle/crypto/engines/IESEngine;->processBlock([BII)[B
    ...
    :cond_3
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->key:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;

    instance-of v1, v1, Lorg/bouncycastle/crypto/params/X25519PublicKeyParameters;

    if-nez v1, :cond_4

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->key:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;

    instance-of v1, v1, Lorg/bouncycastle/crypto/params/X25519PrivateKeyParameters;
    ...
    new-instance v2, Lorg/bouncycastle/crypto/generators/X25519KeyPairGenerator;

    invoke-direct {v2}, Lorg/bouncycastle/crypto/generators/X25519KeyPairGenerator;-><init>()V

    :goto_5
    new-instance v4, Lorg/bouncycastle/crypto/KeyGenerationParameters;

    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->random:Ljava/security/SecureRandom;

    invoke-direct {v4, v6, v1}, Lorg/bouncycastle/crypto/KeyGenerationParameters;-><init>(Ljava/security/SecureRandom;I)V

    invoke-interface {v2, v4}, Lorg/bouncycastle/crypto/AsymmetricCipherKeyPairGenerator;->init(Lorg/bouncycastle/crypto/KeyGenerationParameters;)V
    ...
    invoke-direct {v4, p0, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher$1;-><init>(Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;Z)V

    invoke-direct {v1, v2, v4}, Lorg/bouncycastle/crypto/generators/EphemeralKeyPairGenerator;-><init>(Lorg/bouncycastle/crypto/AsymmetricCipherKeyPairGenerator;Lorg/bouncycastle/crypto/KeyEncoder;)V

    :try_start_1
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->engine:Lorg/bouncycastle/crypto/engines/IESEngine;

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->key:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;

    invoke-virtual {v2, v3, v0, v1}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/generators/EphemeralKeyPairGenerator;)V
    ...
    :cond_8
    new-instance v2, Lorg/bouncycastle/crypto/generators/X448KeyPairGenerator;

    invoke-direct {v2}, Lorg/bouncycastle/crypto/generators/X448KeyPairGenerator;-><init>()V
    ...
    invoke-direct {v4, v3}, Lorg/bouncycastle/crypto/parsers/XIESPublicKeyParser;-><init>(Z)V

    invoke-virtual {v1, v2, v0, v4}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/KeyParser;)V
...
.method public engineGetKeySize(Ljava/security/Key;)I
    ...
    const-string v3, "unknown XDH key algorithm "
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->key:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    const-string v1, "must be passed recipient\'s public XDH key for encryption"
    ...
    const-string v1, "must be passed recipient\'s private XDH key for decryption"
    ...
    const-string v1, "must be passed XDH key"
