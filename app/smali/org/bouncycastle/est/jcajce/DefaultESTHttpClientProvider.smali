...
.method public makeClient()Lorg/bouncycastle/est/ESTClient;
    ...
    new-instance v8, Lorg/bouncycastle/est/jcajce/DefaultESTClient;

    new-instance v0, Lorg/bouncycastle/est/jcajce/DefaultESTClientSourceProvider;

    iget-object v2, p0, Lorg/bouncycastle/est/jcajce/DefaultESTHttpClientProvider;->hostNameAuthorizer:Lorg/bouncycastle/est/jcajce/JsseHostnameAuthorizer;

    iget v3, p0, Lorg/bouncycastle/est/jcajce/DefaultESTHttpClientProvider;->timeout:I

    iget-object v4, p0, Lorg/bouncycastle/est/jcajce/DefaultESTHttpClientProvider;->bindingProvider:Lorg/bouncycastle/est/jcajce/ChannelBindingProvider;

    iget-object v5, p0, Lorg/bouncycastle/est/jcajce/DefaultESTHttpClientProvider;->cipherSuites:Ljava/util/Set;

    iget-object v6, p0, Lorg/bouncycastle/est/jcajce/DefaultESTHttpClientProvider;->absoluteLimit:Ljava/lang/Long;

    iget-boolean v7, p0, Lorg/bouncycastle/est/jcajce/DefaultESTHttpClientProvider;->filterCipherSuites:Z

    invoke-direct/range {v0 .. v7}, Lorg/bouncycastle/est/jcajce/DefaultESTClientSourceProvider;-><init>(Ljavax/net/ssl/SSLSocketFactory;Lorg/bouncycastle/est/jcajce/JsseHostnameAuthorizer;ILorg/bouncycastle/est/jcajce/ChannelBindingProvider;Ljava/util/Set;Ljava/lang/Long;Z)V

    invoke-direct {v8, v0}, Lorg/bouncycastle/est/jcajce/DefaultESTClient;-><init>(Lorg/bouncycastle/est/ESTClientSourceProvider;)V
    :try_end_0
