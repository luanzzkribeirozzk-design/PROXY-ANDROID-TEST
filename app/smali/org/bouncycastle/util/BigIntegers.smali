...
.method public static asUnsignedByteArray(Ljava/math/BigInteger;[BII)V
    ...
    invoke-static {p1, p2, v5, v1}, Lorg/bouncycastle/util/Arrays;->fill([BIIB)V
...
.method public static createRandomPrime(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget v1, Lorg/bouncycastle/util/BigIntegers;->MAX_SMALL:I

    if-le p0, v1, :cond_3

    :goto_1
    sget-object v1, Lorg/bouncycastle/util/BigIntegers;->SMALL_PRIMES_PRODUCT:Ljava/math/BigInteger;
...
.method public static modOddInverse(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {v1, v0, v3}, Lorg/bouncycastle/math/raw/Mod;->modOddInverse([I[I[I)I
    ...
    :cond_4
    invoke-static {v2, v3}, Lorg/bouncycastle/math/raw/Nat;->toBigInteger(I[I)Ljava/math/BigInteger;
...
.method public static modOddInverseVar(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {v1, v0, v3}, Lorg/bouncycastle/math/raw/Mod;->modOddInverseVar([I[I[I)Z
...
.method public static modOddIsCoprime(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    invoke-static {v2, p0}, Lorg/bouncycastle/math/raw/Nat;->fromBigInteger(ILjava/math/BigInteger;)[I

    move-result-object v3

    invoke-static {v2, p1}, Lorg/bouncycastle/math/raw/Nat;->fromBigInteger(ILjava/math/BigInteger;)[I

    move-result-object v2

    invoke-static {v3, v2}, Lorg/bouncycastle/math/raw/Mod;->modOddIsCoprime([I[I)I
...
.method public static modOddIsCoprimeVar(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    invoke-static {v1, v0}, Lorg/bouncycastle/math/raw/Mod;->modOddIsCoprimeVar([I[I)Z
