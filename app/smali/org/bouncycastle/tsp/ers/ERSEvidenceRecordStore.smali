...
.method public constructor <init>(Ljava/util/Collection;)V
    ...
    iput-object v4, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordStore;->digCalc:Lorg/bouncycastle/operator/DigestCalculator;
    ...
    invoke-direct {p0, v6, v0}, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordStore;->addRecord(Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordStore$HashNode;Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;)V
    ...
    iget-object v5, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordStore;->digCalc:Lorg/bouncycastle/operator/DigestCalculator;

    invoke-static {v5, v4}, Lorg/bouncycastle/tsp/ers/ERSUtil;->computeNodeHash(Lorg/bouncycastle/operator/DigestCalculator;Lorg/bouncycastle/asn1/tsp/PartialHashtree;)[B

    move-result-object v4

    invoke-direct {v1, v4}, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordStore$HashNode;-><init>([B)V
    ...
    invoke-direct {v4, v1}, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordStore$HashNode;-><init>([B)V
...
.method public getMatches(Lorg/bouncycastle/util/Selector;)Ljava/util/Collection;
    ...
    check-cast v0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordSelector;

    invoke-virtual {v0}, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordSelector;->getData()Lorg/bouncycastle/tsp/ers/ERSData;
    ...
    invoke-interface {v0, v3, v4}, Lorg/bouncycastle/tsp/ers/ERSData;->getHash(Lorg/bouncycastle/operator/DigestCalculator;[B)[B

    move-result-object v0

    invoke-direct {v1, v0}, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecordStore$HashNode;-><init>([B)V
