...
.method static buildHashList(Lorg/bouncycastle/operator/DigestCalculator;Ljava/util/List;[B)Ljava/util/List;
    ...
    new-instance v2, Lorg/bouncycastle/tsp/ers/SortedHashList;

    invoke-direct {v2}, Lorg/bouncycastle/tsp/ers/SortedHashList;-><init>()V
    ...
    invoke-interface {v0, p0, p2}, Lorg/bouncycastle/tsp/ers/ERSData;->getHash(Lorg/bouncycastle/operator/DigestCalculator;[B)[B

    move-result-object v0

    invoke-virtual {v2, v0}, Lorg/bouncycastle/tsp/ers/SortedHashList;->add([B)V
    ...
    :cond_0
    invoke-virtual {v2}, Lorg/bouncycastle/tsp/ers/SortedHashList;->toList()Ljava/util/List;
...
.method static buildIndexedHashList(Lorg/bouncycastle/operator/DigestCalculator;Ljava/util/List;[B)Ljava/util/List;
    ...
    new-instance v2, Lorg/bouncycastle/tsp/ers/SortedIndexedHashList;

    invoke-direct {v2}, Lorg/bouncycastle/tsp/ers/SortedIndexedHashList;-><init>()V
    ...
    invoke-direct {v3, v1, v0}, Lorg/bouncycastle/tsp/ers/IndexedHash;-><init>(I[B)V

    invoke-virtual {v2, v3}, Lorg/bouncycastle/tsp/ers/SortedIndexedHashList;->add(Lorg/bouncycastle/tsp/ers/IndexedHash;)V
    ...
    :cond_0
    invoke-virtual {v2}, Lorg/bouncycastle/tsp/ers/SortedIndexedHashList;->toList()Ljava/util/List;
...
.method static buildIndexedHashList([[B)Ljava/util/List;
    ...
    invoke-virtual {v1, v2}, Lorg/bouncycastle/tsp/ers/SortedHashList;->add([B)V
...
.method static concatPreviousHashes(Lorg/bouncycastle/operator/DigestCalculator;[B[B)[B
    ...
    const-string v1, "unable to hash data"
