...
.method public constructor <init>(Lorg/bouncycastle/asn1/tsp/EvidenceRecord;Lorg/bouncycastle/operator/DigestCalculatorProvider;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->primaryArchiveTimeStamp:Lorg/bouncycastle/asn1/tsp/ArchiveTimeStamp;

    invoke-direct {p0, v2}, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->validateChains([Lorg/bouncycastle/asn1/tsp/ArchiveTimeStampChain;)V
    ...
    invoke-direct {v0, v4, p2}, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStamp;-><init>(Lorg/bouncycastle/asn1/tsp/ArchiveTimeStamp;Lorg/bouncycastle/operator/DigestCalculatorProvider;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStamp;->getDigestAlgorithmIdentifier()Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    iput-object v0, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->digCalc:Lorg/bouncycastle/operator/DigestCalculator;

    iget-object v0, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->digCalc:Lorg/bouncycastle/operator/DigestCalculator;
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/asn1/DERSequence;->getEncoded(Ljava/lang/String;)[B
    ...
    iput-object v0, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->previousChainsDigest:[B
    :try_end_0
    ...
    invoke-direct {v0, v2, v1, p2}, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStamp;-><init>([BLorg/bouncycastle/asn1/tsp/ArchiveTimeStamp;Lorg/bouncycastle/operator/DigestCalculatorProvider;)V

    iput-object v0, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->firstArchiveTimeStamp:Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStamp;
    ...
    :cond_1
    iput-object v5, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->digCalc:Lorg/bouncycastle/operator/DigestCalculator;

    iput-object v5, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->previousChainsDigest:[B
...
.method private buildTspRenewalGenerator()Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStampGenerator;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStamp;->getDigestAlgorithmIdentifier()Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    :cond_0
    new-instance v3, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStampGenerator;

    invoke-direct {v3, v1}, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStampGenerator;-><init>(Lorg/bouncycastle/operator/DigestCalculator;)V
    ...
    :cond_1
    new-instance v0, Lorg/bouncycastle/tsp/ers/ERSDataGroup;

    invoke-direct {v0, v1}, Lorg/bouncycastle/tsp/ers/ERSDataGroup;-><init>(Ljava/util/List;)V

    invoke-virtual {v3, v0}, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStampGenerator;->addData(Lorg/bouncycastle/tsp/ers/ERSData;)V
...
.method private validateChains([Lorg/bouncycastle/asn1/tsp/ArchiveTimeStampChain;)V
    ...
    invoke-virtual {v6, v7}, Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;->equals(Ljava/lang/Object;)Z
    ...
    const-string v1, "invalid digest algorithm in chain"
    ...
    invoke-interface {v8, v6}, Lorg/bouncycastle/operator/DigestCalculatorProvider;->get(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;)Lorg/bouncycastle/operator/DigestCalculator;

    move-result-object v8

    new-instance v9, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStamp;

    invoke-direct {v9, v4, v8}, Lorg/bouncycastle/tsp/ers/ERSArchiveTimeStamp;-><init>(Lorg/bouncycastle/asn1/tsp/ArchiveTimeStamp;Lorg/bouncycastle/operator/DigestCalculator;)V
    ...
    const-string v1, "cannot identify TSTInfo"
    ...
    const-string v3, "invalid timestamp renewal found: "
...
.method public generateHashRenewalRequest(Lorg/bouncycastle/operator/DigestCalculator;Lorg/bouncycastle/tsp/ers/ERSData;Lorg/bouncycastle/tsp/TimeStampRequestGenerator;Ljava/math/BigInteger;)Lorg/bouncycastle/tsp/TimeStampRequest;
    ...
    const-string v1, "attempt to hash renew on invalid data"
...
.method public renewHash(Lorg/bouncycastle/operator/DigestCalculator;Lorg/bouncycastle/tsp/ers/ERSData;Lorg/bouncycastle/tsp/TimeStampResponse;)Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;
    ...
    new-instance v1, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;

    iget-object v2, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->evidenceRecord:Lorg/bouncycastle/asn1/tsp/EvidenceRecord;

    const/4 v3, 0x1

    invoke-virtual {v2, v0, v3}, Lorg/bouncycastle/asn1/tsp/EvidenceRecord;->addArchiveTimeStamp(Lorg/bouncycastle/asn1/tsp/ArchiveTimeStamp;Z)Lorg/bouncycastle/asn1/tsp/EvidenceRecord;

    move-result-object v0

    iget-object v2, p0, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;->digestCalculatorProvider:Lorg/bouncycastle/operator/DigestCalculatorProvider;

    invoke-direct {v1, v0, v2}, Lorg/bouncycastle/tsp/ers/ERSEvidenceRecord;-><init>(Lorg/bouncycastle/asn1/tsp/EvidenceRecord;Lorg/bouncycastle/operator/DigestCalculatorProvider;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
