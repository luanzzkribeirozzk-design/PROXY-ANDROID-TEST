...
.method public engineValidate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    ...
    invoke-virtual/range {v28 .. v28}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->getCertPathCheckers()Ljava/util/List;
    ...
    instance-of v5, v2, Ljava/security/cert/PKIXRevocationChecker;
    ...
    const-string v3, "only one PKIXRevocationChecker allowed"
    ...
    :cond_7
    instance-of v3, v2, Lorg/bouncycastle/jcajce/PKIXCertRevocationChecker;

    if-eqz v3, :cond_8

    check-cast v2, Lorg/bouncycastle/jcajce/PKIXCertRevocationChecker;
    ...
    invoke-direct {v3, v2}, Lorg/bouncycastle/jce/provider/WrappedRevocationChecker;-><init>(Ljava/security/cert/PKIXCertPathChecker;)V
    ...
    :cond_a
    invoke-virtual/range {v28 .. v28}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->isRevocationEnabled()Z
    ...
    iget-object v2, v0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:Lorg/bouncycastle/jcajce/util/JcaJceHelper;
    ...
    new-instance v30, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;

    invoke-direct/range {v30 .. v30}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;-><init>()V

    new-instance v13, Ljava/util/HashSet;

    invoke-direct {v13}, Ljava/util/HashSet;-><init>()V

    invoke-virtual/range {v28 .. v28}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->isExplicitPolicyRequired()Z
    ...
    :goto_5
    invoke-virtual/range {v28 .. v28}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->isAnyPolicyInhibited()Z
    ...
    :goto_6
    invoke-virtual/range {v28 .. v28}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->isPolicyMappingInhibited()Z
    ...
    invoke-virtual/range {v28 .. v28}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->getTargetConstraints()Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;
    ...
    invoke-virtual {v6, v3}, Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;->match(Ljava/security/cert/Certificate;)Z
    ...
    :cond_f
    :try_start_4
    invoke-static/range {v27 .. v27}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getCA(Ljava/security/cert/TrustAnchor;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :goto_a
    :try_start_5
    invoke-static/range {v18 .. v18}, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->checkCertificate(Ljava/security/cert/X509Certificate;)V
    :try_end_5
    ...
    iget-boolean v2, v0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->isForCRLCheck:Z
    ...
    iget-boolean v0, v0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->isForCRLCheck:Z
    ...
    iget-object v7, v0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:Lorg/bouncycastle/jcajce/util/JcaJceHelper;
