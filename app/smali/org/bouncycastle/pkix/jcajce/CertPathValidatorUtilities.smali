...
.method protected static findCertificates(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p0, v0}, Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;->getCertificates(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
.method protected static findCertificates(Lorg/bouncycastle/pkix/jcajce/X509CertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    instance-of v4, v0, Lorg/bouncycastle/util/Store;
    ...
    instance-of v5, v0, Lorg/bouncycastle/util/Encodable;

    if-eqz v5, :cond_1

    new-instance v5, Ljava/io/ByteArrayInputStream;

    check-cast v0, Lorg/bouncycastle/util/Encodable;
    ...
    invoke-interface {v1, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z
    :try_end_2
    .catch Lorg/bouncycastle/util/StoreException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    throw v0
    :try_end_3
    .catch Lorg/bouncycastle/util/StoreException; {:try_start_3 .. :try_end_3} :catch_0
    ...
    invoke-interface {v1, v0}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z
    :try_end_4
    .catch Ljava/security/cert/CertStoreException; {:try_start_4 .. :try_end_4} :catch_4
...
.method protected static getCertStatus(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/pkix/jcajce/CertStatus;)V
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :cond_5
    invoke-virtual {p3, v1}, Lorg/bouncycastle/pkix/jcajce/CertStatus;->setCertStatus(I)V

    invoke-virtual {v0}, Ljava/security/cert/X509CRLEntry;->getRevocationDate()Ljava/util/Date;

    move-result-object v0

    invoke-virtual {p3, v0}, Lorg/bouncycastle/pkix/jcajce/CertStatus;->setRevocationDate(Ljava/util/Date;)V
...
.method protected static prepareNextCertB1(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->getValidPolicy()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->setExpectedPolicies(Ljava/util/Set;)V
    ...
    :try_start_0
    sget-object v1, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;

    invoke-static {p4, v1}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v1}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getQualifierSet(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    :try_end_2
    ...
    :cond_4
    invoke-virtual {v0}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->getParent()Ljava/security/cert/PolicyNode;
...
.method protected static prepareNextCertB2(I[Ljava/util/List;Ljava/lang/String;Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;
    ...
    invoke-virtual {v1, v0}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->removeChild(Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->hasChildren()Z

    move-result v6

    if-nez v6, :cond_2

    invoke-static {v2, p1, v0}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->removePolicyNode(Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;
...
.method protected static processCertD1i(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)Z
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->getExpectedPolicies()Ljava/util/Set;
