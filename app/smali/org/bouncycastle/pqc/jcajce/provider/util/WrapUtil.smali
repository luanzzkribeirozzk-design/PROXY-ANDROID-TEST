...
.method public static getKeyUnwrapper(Lorg/bouncycastle/jcajce/spec/KTSParameterSpec;[B)Lorg/bouncycastle/crypto/Wrapper;
    ...
    invoke-direct {v1, p1, v3, v2}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([BII)V
...
.method private static makeKeyBytes(Lorg/bouncycastle/jcajce/spec/KTSParameterSpec;[B)[B
    ...
    invoke-interface {v3, v2, v5, v0}, Lorg/bouncycastle/crypto/DerivationFunction;->generateBytes([BII)I
    ...
    invoke-interface {v0, p1, v5, v3}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    array-length v3, v1

    invoke-interface {v0, v1, v5, v3}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    const-string v3, "Unrecognized KDF: "
