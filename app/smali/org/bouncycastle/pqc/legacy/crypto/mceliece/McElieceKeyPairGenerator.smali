...
.method private genKeyPair()Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    :cond_0
    new-instance v3, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2mField;
    ...
    invoke-direct {v3, v0, v1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2mField;-><init>(II)V
    ...
    invoke-direct {v4, v3, v0, v1, v2}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/PolynomialGF2mSmallM;-><init>(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2mField;ICLjava/security/SecureRandom;)V

    new-instance v0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/PolynomialRingGF2m;

    invoke-direct {v0, v3, v4}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/PolynomialRingGF2m;-><init>(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2mField;Lorg/bouncycastle/pqc/legacy/math/linearalgebra/PolynomialGF2mSmallM;)V
    ...
    invoke-static {v3, v4}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GoppaCode;->createCanonicalCheckMatrix(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2mField;Lorg/bouncycastle/pqc/legacy/math/linearalgebra/PolynomialGF2mSmallM;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;
    ...
    invoke-static {v2, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;->createRandomRegularMatrixAndItsInverse(ILjava/security/SecureRandom;)[Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;

    move-result-object v7

    new-instance v6, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;

    iget v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceKeyPairGenerator;->n:I
    ...
    invoke-direct {v6, v0, v8}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;-><init>(ILjava/security/SecureRandom;)V
    ...
    invoke-virtual {v0, v6}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;->rightMultiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Matrix;

    move-result-object v0

    check-cast v0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;

    new-instance v8, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;

    iget v1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceKeyPairGenerator;->n:I

    iget v9, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceKeyPairGenerator;->t:I

    invoke-direct {v8, v1, v9, v0}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;-><init>(IILorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;)V
...
.method private initializeDefault()V
    ...
    invoke-direct {v2}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceParameters;-><init>()V

    invoke-direct {v0, v1, v2}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceKeyGenerationParameters;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceParameters;)V
