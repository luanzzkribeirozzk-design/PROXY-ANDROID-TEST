...
.method private compactPublicKey([[[S)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->pub_quadratic:[[S
...
.method private computePublicKey()V
    ...
    new-instance v8, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;

    invoke-direct {v8}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;-><init>()V
    ...
    iput-object v3, v0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->pub_scalar:[S
    ...
    iget-object v0, v0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A2:[[S
    ...
    invoke-virtual {v8, v0, v1}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S
    ...
    invoke-virtual {v8, v0, v1}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->multVects([S[S)[[S
    ...
    invoke-virtual {v8, v0, v1}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->addSquareMatrix([[S[[S)[[S
    ...
    iget-object v0, v0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->b2:[S
    ...
    iget-object v0, v0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->pub_singular:[[S
    ...
    invoke-virtual {v8, v0, v1}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->addVect([S[S)[S
    ...
    invoke-static/range {v17 .. v18}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/GF2Field;->multElem(SS)S

    move-result v17

    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->pub_scalar:[S
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/GF2Field;->multElem(SS)S
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    invoke-virtual {v8, v6, v0}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S
    ...
    invoke-virtual {v8, v6, v0}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->addVect([S[S)[S
    ...
    invoke-static/range {v19 .. v20}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/GF2Field;->multElem(SS)S

    move-result v19

    invoke-static/range {v18 .. v19}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    invoke-static/range {v17 .. v18}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    invoke-virtual {v8, v11, v12}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->multMatrix(S[[S)[[S

    move-result-object v11

    invoke-virtual {v8, v10, v11}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->addSquareMatrix([[S[[S)[[S
    ...
    invoke-virtual {v8, v11, v12}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->multVect(S[S)[S

    move-result-object v11

    invoke-virtual {v8, v10, v11}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->addVect([S[S)[S
    ...
    invoke-static {v5, v10}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/GF2Field;->addElem(SS)S
    ...
    iput-object v7, v0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->pub_scalar:[S

    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->compactPublicKey([[[S)V
...
.method private generateL1()V
    ...
    new-instance v4, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;

    invoke-direct {v4}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;-><init>()V

    :goto_0
    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A1inv:[[S
    ...
    :cond_1
    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A1:[[S

    invoke-virtual {v4, v0}, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/util/ComputeInField;->inverse([[S)[[S
...
.method private generateL2()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A2:[[S

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A2inv:[[S
    ...
    :goto_0
    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A2inv:[[S
    ...
    :cond_1
    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A2:[[S
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->b2:[S
...
.method public genKeyPair()Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    iget-object v1, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A1inv:[[S

    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->b1:[S

    iget-object v3, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->A2inv:[[S

    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->b2:[S

    iget-object v5, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->vi:[I

    iget-object v6, p0, Lorg/bouncycastle/pqc/legacy/crypto/rainbow/RainbowKeyPairGenerator;->layers:[Lorg/bouncycastle/pqc/legacy/crypto/rainbow/Layer;
